  ...
  componentDidMount = async () => {
    ...
    try {
      const res = await axios.get(
        `http://localhost:5000/api/v1/suppliers/${this.state.user}/me`,
        config
      );
      this.setState({
  ...
  onSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `http://localhost:5000/api/v1/supplier/${this.state.profile._id}/photo`,
        data,
        config
      );
      // this.setState({
    ...
    return (
      ...
      //               <p className="lead">Jumbo helper text</p> */}
               ...
               <div className="col-lg-6 col-md-6 col-sm-6">
                ...
                <div className="">
                    <label name="name"style={{color:'pink'}} >{name}</label>
                  </div> 
                  <h4 style={{ color: "piank" }}>Website </h4>
                  <div className="">
                    <label name="website" style={{color:'pink'}}>{website}</label>
                  </div> 
              ...
              <div className="ex1  " style={{ color: "piank" }}>
                  ...
                  <div className="card-body row" id="">
                    <div className="col-md-3">
                      ...
                      <div className="col-md-4">
                        <label name="address" style={{color:'pink'}}>{address}</label>
                      </div>
                    ...
                    <div className="col-md-3">
                      <h4>Contact</h4>
                      <div className="">
                        <label name="phone" style={{color:'pink'}}>{phone}</label>
                      </div>
                      <div className="">
                        <label name="email" style={{color:'pink'}}>{email}</label>
                      </div>
                      {/* <div className="col-md-4">
                    ...
                    <div className="col-md-6">
                      <h4>Description</h4>
                      <div className="">
                        <label name="description" style={{color:'pink'}}>{description}</label>
                      </div>
                    </div>
                    <hr></hr>
                  </div>
